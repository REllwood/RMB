...
vi.mock("@/lib/ipc", () => ({
  ipc: {
    ...
    listTaxRates: async () => [{ id: 1, name: "VAT 20%", rate_bp: 2000, inclusive: false, archived: false }],
    listCustomers: async () => [
      { id: 1, name: "Jane Doe", email: "j@d.c", phone: "555", billing_address: "1 St", notes: "", created_at: "2026-06-05" },
    ],
    listItems: async () => [
      { id: 1, kind: "product", name: "Widget", sku: "W", unit: "each", default_price_minor: 1000, default_tax_rate_id: null, tracked: true, qty_on_hand: 3, reorder_point: 5 },
    ],
    listInvoices: async () => [
